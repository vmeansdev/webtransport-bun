...
function cohortGrant(overrides: Partial<CohortGrantV1> = {}): CohortGrantV1 {
	...
	return {
		...
		readinessDeadlineMs: READINESS_DEADLINE_MS_CHAT,
...
describe("cohort-protocol B1 §4.1", () => {
	...
	test("caps and schedule constants are the exact plan values", () => {
		...
		expect(READINESS_DEADLINE_MS_CHAT).toBe(90_000);
		// The closed set is exactly the two D3 deadlines; the 180 s and 300 s
		// members went with the chat 5k and 10k rows.
		expect([...READINESS_DEADLINE_MS_VALUES]).toEqual([30_000, 90_000]);
...
describe("cohort-protocol B1 §4.4/§4.5", () => {
	test("caps and the six-cell cardinality table are the exact plan values", () => {
		...
		const ticker100 = cohortCellCardinality("ticker 100");
		expect(ticker100).toEqual({
			cell: "ticker 100",
			publisherCount: 1,
			workerCount: 8,
			subscriberCount: 100,
		...
		const chat250 = cohortCellCardinality("chat 250");
		expect(chat250).toEqual({
			cell: "chat 250",
			publisherCount: 10,
			workerCount: 8,
			subscriberCount: 250,
		...
		for (const retired of [
			...
			expect(() => cohortCellCardinality(retired)).toThrow(RangeError);
			expect(() => cohortCellGrantParameters(retired)).toThrow(RangeError);
		}
...
describe("cohort-protocol B3.5 §4.1 grant vector and per-cell grant parameters", () => {
	/**
	 * The canonical bytes of one `cohort-grant/v1` at the ticker 100 shape:
	 * 1 publisher, 8 shards, 100 subscribers, 1,000 offered ingress and
	 * 100,000 expanded deliveries. Re-pinned 2026-09-09 for the row that became
	 * the top of the ticker ladder when the D4 preflight retired the 250 row
	 * (deviation 2026-09-09), and 2026-09-08 from the retired ticker
	 * 10k row (same shape) under the physical-budget amendment D3.
	 *
	 * `crates/native/tests/cohort_protocol.rs` holds this same literal as
	 * `RUST_PINNED_TICKER100_GRANT_HEX` and feeds it to the real
	 ...
	 */
	const RUST_PINNED_TICKER100_GRANT_HEX =
		"";

	function pinnedGrantBytes(): Uint8Array {
		return new Uint8Array(Buffer.from(RUST_PINNED_TICKER100_GRANT_HEX, "hex"));
	}
	...
	test("the_shard_bound_is_the_grants_subscriber_total", () => {
		...
		expect(Buffer.from(bytesOfCanonical(parsed.value)).toString("hex")).toBe(
			RUST_PINNED_TICKER100_GRANT_HEX,
		);
		expect(bytes.length).toBe(6_260);
		...
		const row = cohortCellGrantParameters("ticker 100");
	...
	test("every_cell_pins_its_own_duration_and_payload_size", () => {
		...
		for (const row of COHORT_CELL_GRANT_PARAMETERS) {
			...
			if (ticker) {
				...
				const perSecond = Number(row.cell.slice("ticker ".length));
	...
	test("the_exact_d3_table_is_unchanged", () => {
		// The new table is a second constant, not two more columns here. The
		// D3 table has exactly these seven columns and neither of the two grant
