...
cd "$REPO"
CELLS=ticker-fanout/rate-25,ticker-fanout/rate-50,ticker-fanout/rate-100,chat-fanout/subscribers-250,chat-fanout/subscribers-500,chat-fanout/subscribers-1000
REPS=5
PURPOSE=canonical
