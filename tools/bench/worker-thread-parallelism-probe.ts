...
export type ArmRun = {
	...
	drops: {
		...
		/** Native park events. Omitted when the snapshot lacks the field. */
...
async function runChild(
	...
	const result: ArmRun = {
		...
		drops: {
			...
			...(typeof metrics0.datagramsSkippedQueueFull === "number" &&
			typeof metrics1.datagramsSkippedQueueFull === "number"
				? {
						datagramsSkippedQueueFull:
							metrics1.datagramsSkippedQueueFull -
							metrics0.datagramsSkippedQueueFull,
					}
				: {}),
		},
		workerProof: {
