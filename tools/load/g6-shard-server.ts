...
async function main(): Promise<void> {
	...
	// Same reasoning: report the UDP send buffer bytes the addon actually
	// resolved, not the env var we were handed.
	const serverUdpSendBufferBytes = server.serverUdpSendBufferBytes();
