...
fn grant_value(public_key_sha256: &str) -> Value {
    ...
    json!({
        ...
        "messageBytes": 100,
        "expectedOfferedIngress": 1000,
        "expectedExpandedDeliveries": 100000,
...
fn leaf(role: &str, role_id: &str, worker_index: Option<i64>, tag: &str) -> TokenCommitmentLeafV1 {
    TokenCommitmentLeafV1 {
        ...
        cohort_id: "cohort-ticker-100-ws".to_owned(),
        role: role.to_owned(),
...
fn cohort_grant_v1_round_trips_exact_keys_and_signature() {
    ...
    assert_eq!(grant.cohort_id, "cohort-ticker-100-ws");
...
/// 1 publisher, 8 shards, 100 subscribers, 1,000 offered ingress and 100,000
/// expanded deliveries (physical-budget amendment D3; re-pinned 2026-09-09
/// for the row that became the top of the ticker ladder when the D4
/// preflight retired the 250 row, and 2026-09-08 from the retired ticker 10k
/// row, same shape).
///
...
const RUST_PINNED_TICKER100_GRANT_HEX: &str = "";
...
fn pinned_grant() -> (Vec<u8>, Vec<u8>, [u8; 32], Value) {
    let bytes = hex_to_bytes(RUST_PINNED_TICKER100_GRANT_HEX);
...
fn the_shard_bound_is_the_grants_subscriber_total() {
    ...
    // carries for the ticker 100 row.
    assert_eq!(grant.measured_duration_ms, 10_000);
    assert_eq!(grant.message_bytes, 100);
    assert_eq!(grant.window_count(), 10);
...
fn the_residue_class_window_is_one_past_the_last_member() {
    // Ticker 250: 100 subscribers behind one publisher, residue 0 holds
